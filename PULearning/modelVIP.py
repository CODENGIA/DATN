...
class ModernPUGNN(nn.Module):
    ...
    def __init__(self, in_dim=14, hidden_dim=64, dropout=0.3):
        ...
        # Bộ phân loại: Nhận [Đặc trưng GNN (hidden_dim) + Độ lệch sinh học gốc (in_dim)]
    ...
    def forward(self, x_n, x_t, edge_index):
        # 1. Truyền qua GNN để học cấu trúc đồ thị
        ...
        # 3. Gộp tri thức mạng lưới và tri thức sinh học độc lập
